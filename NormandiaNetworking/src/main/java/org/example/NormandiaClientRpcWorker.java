...
public class NormandiaClientRpcWorker implements Runnable, IRezervareObserver{
    ...
    public NormandiaClientRpcWorker(IRezervareServices competitionServices, Socket connection) {
